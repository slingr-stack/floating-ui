...
var sides = exports.sides = ['top', 'right', 'bottom', 'left'];
var alignments = exports.alignments = ['start', 'end'];
var placements = exports.placements = /*#__PURE__*/sides.reduce(function (acc, side) {
...
var createCoords = exports.createCoords = function createCoords(v) {
  return {
    x: v,
    y: v
  };
